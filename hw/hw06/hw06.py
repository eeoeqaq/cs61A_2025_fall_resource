...
class VendingMachine:
    ...
    def restock(self, n: int) -> str:
        ...
        """
        self.stock+=n
        ans=f'Current {self.selling} stock: {self.stock}'
        return ans
    ...
    def add_funds(self, n: int) -> str:
        ...
        """
        if self.stock==0:
            ans=f'Nothing left to vend. Please restock. Here is your ${n}.'
        else:
            self.money+=n
            ans=f'Current balance: ${self.money}'
        return ans
    ...
    def vend(self) -> str:
      ...
      """
        if self.stock==0:
            ans='Nothing left to vend. Please restock.'
        else:
            if self.money<self.price:
                ans=f'Please add ${self.price-self.money} more funds.'  
            elif self.money==self.price:
                self.money=0
                ans=f'Here is your {self.selling}.'
                self.stock-=1
            else:
                ans=f'Here is your {self.selling} and ${self.money-self.price} change.'   
                self.money=0 
                self.stock-=1 
        return ans
