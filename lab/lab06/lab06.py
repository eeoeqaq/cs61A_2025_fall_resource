...
class BankAccount:
    ...
    def deposit(self, amount: int) -> int:
        ...
        self.transactions.append(Transaction(self.trans_id,self.balance-amount,self.balance))
        self.trans_id+=1
        return self.balance
    ...
    def withdraw(self, amount: int) -> int | str:
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.trans_id,self.balance,self.balance))
            self.trans_id+=1
...
class VirFib():
    ...
    def next(self):
        if not hasattr(self,'pre1'):
            self.pre1=1
        a=VirFib(self.value+self.pre1)
        a.pre1=self.value
        return a
