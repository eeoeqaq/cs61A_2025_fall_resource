...
def ten_pairs(n):
    ...
    True
    """
    return int(count_digit(n, 1)*count_digit(n, 9)+count_digit(n, 2)*count_digit(n, 8)+count_digit(n, 3)*count_digit(n, 7)+count_digit(n, 4)*count_digit(n, 6)+count_digit(n, 5)*(count_digit(n, 5)-1)/2)
...
def count_digit(n, digit):
    ...
    if n%10==digit:
        a=1
    return count_digit(n//10,digit)+a
